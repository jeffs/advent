...
mod day10 {
    ...
    pub fn find_corrupt_closer(line: &Vec<u8>) -> Option<u8> {
...
fn main() {
    ...
    let lines = day10::load_lines(input).unwrap_or_else(|err| {
        eprintln!("error: {}: {}", input, err);
        std::process::exit(3);
    });
    println!("{}", day10::part1::solve(&lines));
    println!("{}", day10::part2::solve(&lines));
}

...
mod day6 {
    ...
    pub fn load_fish<P: AsRef<Path>>(input: P) -> Result<Vec<u8>, Box<dyn Error>> {
    ...
    pub fn solve_days(fish: &[u8], days: u32) -> usize {
...
fn main() {
    ...
    let fish = day6::load_fish("tests/day6/input").unwrap_or_else(|err| {
        eprintln!("error: {}: {}", input, err);
        std::process::exit(3);
    });
    println!("{}", day6::part1::solve(&fish));
    println!("{}", day6::part2::solve(&fish));
}
